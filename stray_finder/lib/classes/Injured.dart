...
class Injured {
  ...
  CollectionReference injuries = FirebaseFirestore.instance.collection('injuries');

  Future<void> addInjury(String description, List<String> photos, String passerbyContact, String passerbyName, String catName, GeoPoint lastSeen){
    return injuries
        .doc(catid.toString())
        .set({
      'cat_id': catid,
  ...
  Future<void> deleteInjury() async{
