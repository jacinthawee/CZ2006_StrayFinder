...
int id = 0;
  ...
  Future<void> addCat(int id, String name, String breed, bool statusInjury,
  ...
  Future<List<Map<String, dynamic>>> getAllCatInfo() async {
  ...
  Future<Map<String, dynamic>> getCatInfo(int id) async {
  ...
  Future<List<Map<String, dynamic>>> getAllCatsByBreed(String breed) async {
  ...
  Future<Map<String, dynamic>> getInjuryInfo(int id) async {
  ...
  Future<List<Map<String, dynamic>>> getAllInjuredCats() async {
  ...
  Future<void> updateLocation(int id, GeoPoint newLoc) async {
    await cats
        .doc(id.toString())
  ...
  Future<String> getImgURL(int id) async{
    String img = '';
