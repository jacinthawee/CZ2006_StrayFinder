    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Row(
          //   children: [
          //     Text("Postal Code: ", style: Theme.of(context).textTheme.bodyText1,),
          //     Text(_vet['postal_code'], style: Theme.of(context).textTheme.bodyText2,),
          //   ],
          // ),
          Row(
            children: [
          ...
          TextButton.icon(
            ...
            onPressed: () => VetUI.openMap(_vet['address']), 
